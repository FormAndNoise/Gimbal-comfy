...
log = logging.getLogger("WayfinderGPS_Load")


def _resolve_waypoint_dir() -> Path:
    """Mirror the resolution logic from WayfinderGPS_Anchor for consistency."""
    ...
    def _resolve_path(waypoint_file: str, manual_path: str) -> Path:
        ...
        if waypoint_file == "<no waypoints found>":
            raise FileNotFoundError(
                f"No waypoint files in {WAYFINDER_DIR}. "
                "Run WayfinderGPS_Anchor with save_waypoint=True first, "
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "WayfinderGPS_Load": "Wayfinder GPS Load (Waypoint Reader)",
}
